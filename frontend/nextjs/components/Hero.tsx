    ...
    <div className="relative overflow-visible min-h-[80vh] sm:min-h-[85vh] flex items-center pt-[60px] sm:pt-[80px] mt-[-60px] sm:mt-[-130px]">
      ...
      >
        ...
        >
          ...
          >
            <div className="mb-2 xs:mb-3 sm:mb-1 md:mb-0">Automate Your</div>
            <span
              style={{
          ...
          >
            FAR Part 10 Automated Market Research Tool takes care of everything from accurate source gathering and organization of research results to generation of customized reports with citations.
          </motion.h2>
...
const suggestions: suggestionType[] = [
  {
    id: 1,
    name: "Market research for ",
    icon: "/img/stock2.svg",
  },
  {
    id: 2,
    name: "Vendor capabilities for ",
    icon: "/img/hiker.svg",
  },
  {
    id: 3,
    name: "Industry analysis of ",
    icon: "/img/news.svg",
  },
];
